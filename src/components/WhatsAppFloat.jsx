...
const WhatsAppFloat = () => {
  return (
    <a 
      href="https://wa.me/919550556780" 
      target="_blank" 
      rel="noopener noreferrer"
      className="fixed bottom-6 right-6 z-[200] w-[52px] h-[52px] rounded-full bg-electric flex items-center justify-center shadow-[0_4px_24px_rgba(37,99,235,0.4)] hover:scale-[1.08] hover:shadow-[0_6px_30px_rgba(37,99,235,0.6)] duration-300 pointer-events-auto"
